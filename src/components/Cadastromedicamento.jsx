  ...
  function CadastrarMedicamento() {
    ...
    if (
      ...
      localStorage.setItem(
        "listaMedicamentos",
        JSON.stringify(novaListaMedicamentos)
      );
      limparCampos();
  ...
  return (
    <div className="row col-10 p-3 m-2 ">
      ...
      <form>
        ...
        <div className="row">
          <div className="col-4">
            <label className="form-label">Dosagem do medicamento mg</label>{" "}
            <br />
            <input
          ...
          <div className="col-4">
            <label className="form-label">
              Preço unitário do medicamento R$
            </label>{" "}
            <br />
            <input
