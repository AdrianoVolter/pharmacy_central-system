...
function ListaDeFarmacias() {
  ...
  return (
    ...
    <div className="col-12 container-fluid  p-3  ">
      ...
      <button
        className="  col btn btn-light border p-2 m-2"
        variant="bg-warning"
        type="button"
        value="Cadatrar Farmácia "
        onClick={(e) => handleCdFarm()}
      >
        Cadastrar Farmácia
        ...
        <table className="table table-striped table-hover">
          ...
          <tbody>
            {listaFarmacias.map((farmacia, index) => (
              <tr className="tr">
                <td>
                  <li scope="row" className="list-group-item" key={index}>
                    {index + 1}
                  </li>
                </td>
                <td>{farmacia.nome}</td>
                ...
                <td>
                  <Button
                    variant="primary"
                    className="col btn btn-warning p-2 m-2"
                    onClick={() => abrirModal(index)}
                  >
                    Detalhes <BiCommentDetail className="" />
                  </Button>
                </td>
              </tr>
            ))}
          ...
          <div className="p-3 border bg-warning">
            <div className="row">
              ...
              <div className="row">
                ...
                <div className="col-6">
                  <p>
                    <strong>CNPJ:</strong> {listaFarmacias[modal]?.cnpj}
                  </p>
                </div>
              </div>
              <h5>Contato</h5>
              <div className="row">
                <div className="col-12">
                  <p>
                    <strong>
                      <BsTelephoneInbound /> Telefone :{" "}
                    </strong>
                    {listaFarmacias[modal]?.telefone}
                  </p>
                </div>
                <div className="col-12">
                  <p>
              ...
              <p>
                <strong>
                  <MdAlternateEmail /> E-mail:
                </strong>{" "}
                {listaFarmacias[modal]?.email}
              </p>
              <h5>Endereço</h5>
              <div className="col-12">
                <p>
                  <strong>Logradouro:</strong>{" "}
                  {listaFarmacias[modal]?.logradouro}
                </p>
              </div>
              <div className="row">
                <div className="col-6">
                  <p>
                    <strong>Numero:</strong> {listaFarmacias[modal]?.numero}
                  </p>
                </div>

                <div className="col-6">
                  <p>
                    <strong>Bairro:</strong> {listaFarmacias[modal]?.bairro}
                  </p>
                </div>
              </div>
              <div className="row">
                <div className="col-6">
                  <p>
                    ...
                    {listaFarmacias[modal]?.complemento}
                  </p>
                </div>
                <div className="col-4">
                  <p>
                    <strong>Cep:</strong> {listaFarmacias[modal]?.cep}
                  </p>
                </div>
              </div>
              <div className="row">
                <div className="col-4">
                  <p>
                    <strong>Cidade:</strong> {listaFarmacias[modal]?.cidade}
                  </p>
                </div>
                <div className="col-4">
                  <p>
                    <strong>Estado:</strong> {listaFarmacias[modal]?.estado}
                  </p>
                </div>
              </div>
            </div>
