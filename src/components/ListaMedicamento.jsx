  ...
  return (
    <div className="col-12 container-fluid  p-3  ">
      ...
      <button
        ...
        type="button"
        value="Cadatrar medicamento "
        onClick={(e) => handleCdMed()}
      >
          ...
          {listaMedicamentos.map((medicamento, index) => (
            <div className="col-3 ">
              <div className="col-12 card p-3 m-2" key={index}>
                <img
                  src={imgMedicamento}
                  className="col-12 card-img-top  p-2"
                  alt="..."
                />
                <div className=" card-body p-2">
                  ...
                  <div className="">
                    ...
                    <p className="card-text col-12">
                      <strong>{medicamento.dosagem}</strong> mg
                    </p>
                  </div>
                  <Button
                    className=""
                  ...
                  <Modal show={card === index} onHide={fecharModal}>
                    ...
                    <Modal.Body>
                      <div className="row col-12 border bg-warning">
                        ...
                        <div className="col-6">
                          <p>
                            <strong>Dosagem:</strong> {medicamento.dosagem} mg
                          </p>
                        </div>
                        <div className="col-6">
                          <p>
